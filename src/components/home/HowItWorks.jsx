...
import { Search, User, MapPin } from "lucide-react"; // Assuming lucide-react is available, or I'll use standard SVGs/Emojis if not. 
// The user has lucide-react in DashboardLayout, so it should be available.
...
const steps = [
  {
    ...
    shape: "rounded-tr-[100px] rounded-br-[100px] rounded-tl-[50px] rounded-bl-[50px]", 
  },
  {
    id: "02",
  ...
  },
  {
    ...
    color: "#F79A19", // Orange
    bgColor: "bg-orange-100", 
    shape: "rounded-tl-[100px] rounded-bl-[100px] rounded-tr-[50px] rounded-br-[50px]",
  },
];
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="space-y-24 md:space-y-32">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-12 md:gap-24 relative">
                 ...
                 <div className="bg-white p-4 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] w-[280px] sm:w-[320px] relative z-10 border border-gray-50">
                    ...
                    <div className="space-y-2 mb-4">
                       <div className="flex justify-between items-start">
                           <div>
                               <h4 className="font-bold text-gray-900 text-lg">Special Chicken Biryani</h4>
                       ...
                       <p className="text-xs text-gray-400">Freshly cooked with authentic spices and delivered hot.</p>
                    </div>
            ...
            >
               <h3 className="text-3xl font-bold text-gray-900 mb-4">Choose Your Meal</h3>
               <p className="text-gray-500 leading-relaxed text-lg max-w-md mx-auto md:mx-0">
                 Browse through a variety of authentic homemade meals. We know your home is more than just a place to live, that's why we're committed to providing the best home loan.
               </p>
            </motion.div>
          </div>
          ...
          <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-12 md:gap-24">
            ...
            >
               <h3 className="text-3xl font-bold text-gray-900 mb-4">Chef Cooks with Love</h3>
               <p className="text-gray-500 leading-relaxed text-lg max-w-md mx-auto md:mx-0">
                 Local chefs prepare your order with fresh ingredients. It's the fast, easy way to apply for your mortgage and access your application anytime, anywhere.
               </p>
            </motion.div>
                 ...
                 <div className="bg-white p-4 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] w-[280px] sm:w-[320px] relative z-10 border border-gray-50">
                     <div className="relative h-48 w-full rounded-xl overflow-hidden mb-4">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
                            <h4 className="text-white font-bold text-lg">Chef Michael</h4>
                            <p className="text-gray-200 text-xs text-white/80">Expert in Italian Cuisine</p>
                        </div>
                    </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-12 md:gap-24">
            ...
            >
               ...
               <p className="text-gray-500 leading-relaxed text-lg max-w-md mx-auto md:mx-0">
                 Hot and fresh food delivered straight to your doorstep. It's about you and your family, having a comfortable payment, exceptional service and a lender.
               </p>
            </motion.div>
          </div>
        </div>
